...
import DniproPostCard from '@/components/Posts/Regions/Dnipro/DniproNewsCard';
import BilaCerkvaPostCard from '@/components/Posts/Regions/Kyiv/BilaCerkvaNewsCard';
import RegionsPopover from '@/components/RegionPopover/RegionsPopover';
import { Paths } from '@/paths';
import { useGetAllDniproNewsQuery } from '@/redux/services/regionsNews/Dnipro/dnipro';
import { useGetAllBilacerkvaNewsQuery } from '@/redux/services/regionsNews/Kyiv/bilacerkva';
...
const DniproTheNewsPage: FC = () => {
  ...
  const { data, isLoading } = useGetAllDniproNewsQuery();
  useEffect(() => {
...
export default DniproTheNewsPage;
