...
import KamianskePostCard from '@/components/Posts/Regions/Dnipro/KamianskeNewsCard';
import RegionsPopover from '@/components/RegionPopover/RegionsPopover';
import { Paths } from '@/paths';
import { useGetAllKamianskeNewsQuery } from '@/redux/services/regionsNews/Dnipro/dnipro';
import { News } from '@/types/news';
import { Button, Input, Pagination, Spin } from 'antd';
import { FC, useEffect, useState } from 'react';
import { useNavigate } from 'react-router-dom';

const KamianskeTheNewsPage: FC = () => {
  ...
  const { data, isLoading } = useGetAllKamianskeNewsQuery();
  useEffect(() => {
...
export default KamianskeTheNewsPage;
