...
import KryvyiRihPostCard from '@/components/Posts/Regions/Dnipro/KryvyiRihNewsCard';
import RegionsPopover from '@/components/RegionPopover/RegionsPopover';
import { Paths } from '@/paths';
import { useGetAllKryvyiRihNewsQuery } from '@/redux/services/regionsNews/Dnipro/dnipro';
import { News } from '@/types/news';
import { Button, Input, Pagination, Spin } from 'antd';
import { FC, useEffect, useState } from 'react';
import { useNavigate } from 'react-router-dom';

const KryvyiRihTheNewsPage: FC = () => {
  ...
  const { data, isLoading } = useGetAllKryvyiRihNewsQuery();
  useEffect(() => {
...
export default KryvyiRihTheNewsPage;
