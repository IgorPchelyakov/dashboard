...
import MarganetsPostCard from '@/components/Posts/Regions/Dnipro/MarganetsNewsCard';
import RegionsPopover from '@/components/RegionPopover/RegionsPopover';
import { Paths } from '@/paths';
import { useGetAllMarganetsNewsQuery } from '@/redux/services/regionsNews/Dnipro/dnipro';
import { News } from '@/types/news';
import { Button, Input, Pagination, Spin } from 'antd';
import { FC, useEffect, useState } from 'react';
import { useNavigate } from 'react-router-dom';

const MarganetsTheNewsPage: FC = () => {
  ...
  const { data, isLoading } = useGetAllMarganetsNewsQuery();
  useEffect(() => {
...
export default MarganetsTheNewsPage;
