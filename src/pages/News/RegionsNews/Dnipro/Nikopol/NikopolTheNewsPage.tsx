...
import NikopolPostCard from '@/components/Posts/Regions/Dnipro/NikopolNewsCard';
import RegionsPopover from '@/components/RegionPopover/RegionsPopover';
import { Paths } from '@/paths';
import { useGetAllNikopolNewsQuery } from '@/redux/services/regionsNews/Dnipro/dnipro';
import { News } from '@/types/news';
import { Button, Input, Pagination, Spin } from 'antd';
import { FC, useEffect, useState } from 'react';
import { useNavigate } from 'react-router-dom';

const NikopolTheNewsPage: FC = () => {
  ...
  const { data, isLoading } = useGetAllNikopolNewsQuery();
  useEffect(() => {
...
export default NikopolTheNewsPage;
