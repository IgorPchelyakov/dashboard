...
import NovomoskovskPostCard from '@/components/Posts/Regions/Dnipro/NovomoskovskNewsCard';
import RegionsPopover from '@/components/RegionPopover/RegionsPopover';
import { Paths } from '@/paths';
import { useGetAllNovomoskovskNewsQuery } from '@/redux/services/regionsNews/Dnipro/dnipro';
import { News } from '@/types/news';
import { Button, Input, Pagination, Spin } from 'antd';
import { FC, useEffect, useState } from 'react';
import { useNavigate } from 'react-router-dom';

const NovomoskovskTheNewsPage: FC = () => {
  ...
  const { data, isLoading } = useGetAllNovomoskovskNewsQuery();
  useEffect(() => {
...
export default NovomoskovskTheNewsPage;
