...
import PavlogradPostCard from '@/components/Posts/Regions/Dnipro/PavlogradNewsCard';
import RegionsPopover from '@/components/RegionPopover/RegionsPopover';
import { Paths } from '@/paths';
import { useGetAllPavlogradNewsQuery } from '@/redux/services/regionsNews/Dnipro/dnipro';
import { News } from '@/types/news';
import { Button, Input, Pagination, Spin } from 'antd';
import { FC, useEffect, useState } from 'react';
import { useNavigate } from 'react-router-dom';

const PavlogradTheNewsPage: FC = () => {
  ...
  const { data, isLoading } = useGetAllPavlogradNewsQuery();
  useEffect(() => {
...
export default PavlogradTheNewsPage;
