...
import PershotravenskPostCard from '@/components/Posts/Regions/Dnipro/PershotravenskNewsCard';
import RegionsPopover from '@/components/RegionPopover/RegionsPopover';
import { Paths } from '@/paths';
import { useGetAllPershotravenskNewsQuery } from '@/redux/services/regionsNews/Dnipro/dnipro';
import { News } from '@/types/news';
import { Button, Input, Pagination, Spin } from 'antd';
import { FC, useEffect, useState } from 'react';
import { useNavigate } from 'react-router-dom';

const PershotravenskTheNewsPage: FC = () => {
  ...
  const { data, isLoading } = useGetAllPershotravenskNewsQuery();
  useEffect(() => {
...
export default PershotravenskTheNewsPage;
