...
import PokrovPostCard from '@/components/Posts/Regions/Dnipro/PokrovNewsCard';
import RegionsPopover from '@/components/RegionPopover/RegionsPopover';
import { Paths } from '@/paths';
import { useGetAllPokrovNewsQuery } from '@/redux/services/regionsNews/Dnipro/dnipro';
import { News } from '@/types/news';
import { Button, Input, Pagination, Spin } from 'antd';
import { FC, useEffect, useState } from 'react';
import { useNavigate } from 'react-router-dom';

const PokrovTheNewsPage: FC = () => {
  ...
  const { data, isLoading } = useGetAllPokrovNewsQuery();
  useEffect(() => {
...
export default PokrovTheNewsPage;
