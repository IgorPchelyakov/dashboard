...
import PyatihatkyPostCard from '@/components/Posts/Regions/Dnipro/PyatihatkyNewsCard';
import RegionsPopover from '@/components/RegionPopover/RegionsPopover';
import { Paths } from '@/paths';
import { useGetAllPyatihatkyNewsQuery } from '@/redux/services/regionsNews/Dnipro/dnipro';
import { News } from '@/types/news';
import { Button, Input, Pagination, Spin } from 'antd';
import { FC, useEffect, useState } from 'react';
import { useNavigate } from 'react-router-dom';

const PyatihatkyTheNewsPage: FC = () => {
  ...
  const { data, isLoading } = useGetAllPyatihatkyNewsQuery();
  useEffect(() => {
...
export default PyatihatkyTheNewsPage;
