...
import SinelnikovoPostCard from '@/components/Posts/Regions/Dnipro/SinelnikovoNewsCard';
import RegionsPopover from '@/components/RegionPopover/RegionsPopover';
import { Paths } from '@/paths';
import { useGetAllSinelnikovoNewsQuery } from '@/redux/services/regionsNews/Dnipro/dnipro';
import { News } from '@/types/news';
import { Button, Input, Pagination, Spin } from 'antd';
import { FC, useEffect, useState } from 'react';
import { useNavigate } from 'react-router-dom';

const SinelnikovoTheNewsPage: FC = () => {
  ...
  const { data, isLoading } = useGetAllSinelnikovoNewsQuery();
  useEffect(() => {
...
export default SinelnikovoTheNewsPage;
