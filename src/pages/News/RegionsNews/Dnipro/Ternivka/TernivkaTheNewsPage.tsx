...
import TernivkaPostCard from '@/components/Posts/Regions/Dnipro/TernivkaNewsCard';
import RegionsPopover from '@/components/RegionPopover/RegionsPopover';
import { Paths } from '@/paths';
import { useGetAllTernivkaNewsQuery } from '@/redux/services/regionsNews/Dnipro/dnipro';
import { News } from '@/types/news';
import { Button, Input, Pagination, Spin } from 'antd';
import { FC, useEffect, useState } from 'react';
import { useNavigate } from 'react-router-dom';

const TernivkaTheNewsPage: FC = () => {
  ...
  const { data, isLoading } = useGetAllTernivkaNewsQuery();
  useEffect(() => {
...
export default TernivkaTheNewsPage;
