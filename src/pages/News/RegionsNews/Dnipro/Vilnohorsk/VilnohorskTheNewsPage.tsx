...
import VilnohorskPostCard from '@/components/Posts/Regions/Dnipro/VilnohorskNewsCard';
import RegionsPopover from '@/components/RegionPopover/RegionsPopover';
import { Paths } from '@/paths';
import { useGetAllVilnohorskNewsQuery } from '@/redux/services/regionsNews/Dnipro/dnipro';
import { News } from '@/types/news';
import { Button, Input, Pagination, Spin } from 'antd';
import { FC, useEffect, useState } from 'react';
import { useNavigate } from 'react-router-dom';

const VilnohorskTheNewsPage: FC = () => {
  ...
  const { data, isLoading } = useGetAllVilnohorskNewsQuery();
  useEffect(() => {
...
export default VilnohorskTheNewsPage;
