...
import ZhovtiVodyPostCard from '@/components/Posts/Regions/Dnipro/ZhovtiVodyNewsCard';
import RegionsPopover from '@/components/RegionPopover/RegionsPopover';
import { Paths } from '@/paths';
import { useGetAllZhovtiVodyNewsQuery } from '@/redux/services/regionsNews/Dnipro/dnipro';
import { News } from '@/types/news';
import { Button, Input, Pagination, Spin } from 'antd';
import { FC, useEffect, useState } from 'react';
import { useNavigate } from 'react-router-dom';

const ZhovtiVodyTheNewsPage: FC = () => {
  ...
  const { data, isLoading } = useGetAllZhovtiVodyNewsQuery();
  useEffect(() => {
...
export default ZhovtiVodyTheNewsPage;
