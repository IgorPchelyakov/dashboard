...
import BerezanPostCard from '@/components/Posts/Regions/Kyiv/BerezanNewsCard';
...
const BerezanTheNewsPage: FC = () => {
  ...
  const { data, isLoading } = useGetAllBerezanNewsQuery();
  useEffect(() => {
...
export default BerezanTheNewsPage;
