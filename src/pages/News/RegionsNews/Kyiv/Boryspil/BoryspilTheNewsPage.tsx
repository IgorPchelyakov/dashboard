...
import BoryspilPostCard from '@/components/Posts/Regions/Kyiv/BoryspilNewsCard';
import RegionsPopover from '@/components/RegionPopover/RegionsPopover';
import { Paths } from '@/paths';
import { useGetAllBoryspilNewsQuery } from '@/redux/services/regionsNews/Kyiv/boryspil';
...
const BoryspilTheNewsPage: FC = () => {
  ...
  const { data, isLoading } = useGetAllBoryspilNewsQuery();
  useEffect(() => {
...
export default BoryspilTheNewsPage;
