...
import BoyarkaPostCard from '@/components/Posts/Regions/Kyiv/BoyarkaNewsCard';
...
const BoyarkaTheNewsPage = () => {
    ...
    const { data, isLoading } = useGetAllBoyarkaNewsQuery();
    useEffect(() => {
