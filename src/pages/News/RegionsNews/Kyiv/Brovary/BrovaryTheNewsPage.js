...
import BrovaryPostCard from '@/components/Posts/Regions/Kyiv/BrovaryNewsCard';
import RegionsPopover from '@/components/RegionPopover/RegionsPopover';
import { Paths } from '@/paths';
import { useGetAllBrovaryNewsQuery } from '@/redux/services/regionsNews/Kyiv/brovary';
import { Button, Input, Pagination, Spin } from 'antd';
import { useEffect, useState } from 'react';
import { useNavigate } from 'react-router-dom';
const BrovaryTheNewsPage = () => {
    ...
    const { data, isLoading } = useGetAllBrovaryNewsQuery();
    useEffect(() => {
