...
import BuchaPostCard from '@/components/Posts/Regions/Kyiv/BuchaNewsCard';
...
const BuchaTheNewsPage = () => {
    ...
    const { data, isLoading } = useGetAllBuchaNewsQuery();
    useEffect(() => {
