...
import IrpinPostCard from '@/components/Posts/Regions/Kyiv/IrpinNewsCard';
import RegionsPopover from '@/components/RegionPopover/RegionsPopover';
import { Paths } from '@/paths';
import { useGetAllIrpinNewsQuery } from '@/redux/services/regionsNews/Kyiv/irpin';
import { Button, Input, Pagination, Spin } from 'antd';
import { useEffect, useState } from 'react';
import { useNavigate } from 'react-router-dom';
const IrpinTheNewsPage = () => {
    ...
    const { data, isLoading } = useGetAllIrpinNewsQuery();
    useEffect(() => {
