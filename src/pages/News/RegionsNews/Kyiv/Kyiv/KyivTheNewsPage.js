...
import KyivPostCard from '@/components/Posts/Regions/Kyiv/KyivNewsCard';
import RegionsPopover from '@/components/RegionPopover/RegionsPopover';
import { Paths } from '@/paths';
import { useGetAllKyivNewsQuery } from '@/redux/services/regionsNews/Kyiv/kyiv';
import { Button, Input, Pagination, Spin } from 'antd';
import { useEffect, useState } from 'react';
import { useNavigate } from 'react-router-dom';
const KyivTheNewsPage = () => {
    ...
    const { data, isLoading } = useGetAllKyivNewsQuery();
    useEffect(() => {
