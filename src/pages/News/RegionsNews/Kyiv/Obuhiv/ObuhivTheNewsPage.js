...
import ObukhivPostCard from '@/components/Posts/Regions/Kyiv/ObukhivNewsCard';
import RegionsPopover from '@/components/RegionPopover/RegionsPopover';
import { Paths } from '@/paths';
import { useGetAllObukhivNewsQuery } from '@/redux/services/regionsNews/Kyiv/obukhiv';
import { Button, Input, Pagination, Spin } from 'antd';
import { useEffect, useState } from 'react';
import { useNavigate } from 'react-router-dom';
const ObukhivTheNewsPage = () => {
    ...
    const { data, isLoading } = useGetAllObukhivNewsQuery();
    useEffect(() => {
