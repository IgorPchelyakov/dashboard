...
import PereyaslavPostCard from '@/components/Posts/Regions/Kyiv/PereyaslavNewsCard';
import RegionsPopover from '@/components/RegionPopover/RegionsPopover';
import { Paths } from '@/paths';
import { useGetAllPereyaslavNewsQuery } from '@/redux/services/regionsNews/Kyiv/pereyaslav';
import { Button, Input, Pagination, Spin } from 'antd';
import { useEffect, useState } from 'react';
import { useNavigate } from 'react-router-dom';
const PereyaslavTheNewsPage = () => {
    ...
    const { data, isLoading } = useGetAllPereyaslavNewsQuery();
    useEffect(() => {
