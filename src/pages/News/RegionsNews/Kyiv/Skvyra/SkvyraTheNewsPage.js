...
import SkvyraPostCard from '@/components/Posts/Regions/Kyiv/SkvyraNewsCard';
import RegionsPopover from '@/components/RegionPopover/RegionsPopover';
import { Paths } from '@/paths';
import { useGetAllSkvyraNewsQuery } from '@/redux/services/regionsNews/Kyiv/skvyra';
import { Button, Input, Pagination, Spin } from 'antd';
import { useEffect, useState } from 'react';
import { useNavigate } from 'react-router-dom';
const SkvyraTheNewsPage = () => {
    ...
    const { data, isLoading } = useGetAllSkvyraNewsQuery();
    useEffect(() => {
