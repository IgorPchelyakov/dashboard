...
import SlavutychPostCard from '@/components/Posts/Regions/Kyiv/SlavutychNewsCard';
import RegionsPopover from '@/components/RegionPopover/RegionsPopover';
import { Paths } from '@/paths';
import { useGetAllSlavutychNewsQuery } from '@/redux/services/regionsNews/Kyiv/slavutych';
import { Button, Input, Pagination, Spin } from 'antd';
import { useEffect, useState } from 'react';
import { useNavigate } from 'react-router-dom';
const SlavutychTheNewsPage = () => {
    ...
    const { data, isLoading } = useGetAllSlavutychNewsQuery();
    useEffect(() => {
