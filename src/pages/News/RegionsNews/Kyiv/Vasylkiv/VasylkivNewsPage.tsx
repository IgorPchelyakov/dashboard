...
import { useGetVasylkivNewsByIdQuery } from '@/redux/services/regionsNews/Kyiv/vasylkiv';
moment.locale('uk');

const VasylkivNewsPage: FC = () => {
  const navigate = useNavigate();
  const [error, setError] = useState('');
  const params = useParams<{ id: string }>();

  const { data, isLoading } = useGetVasylkivNewsByIdQuery(params.id || '');
...
export default VasylkivNewsPage;
