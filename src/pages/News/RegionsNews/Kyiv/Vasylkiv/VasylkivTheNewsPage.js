...
import VasylkivPostCard from '@/components/Posts/Regions/Kyiv/VasylkivNewsCard';
import RegionsPopover from '@/components/RegionPopover/RegionsPopover';
import { Paths } from '@/paths';
import { useGetAllVasylkivNewsQuery } from '@/redux/services/regionsNews/Kyiv/vasylkiv';
import { Button, Input, Pagination, Spin } from 'antd';
import { useEffect, useState } from 'react';
import { useNavigate } from 'react-router-dom';
const VasylkivTheNewsPage = () => {
    ...
    const { data, isLoading } = useGetAllVasylkivNewsQuery();
    useEffect(() => {
