...
import VyshhorodPostCard from '@/components/Posts/Regions/Kyiv/VyshhorodNewsCard';
...
const VyshhorodTheNewsPage = () => {
    ...
    const { data, isLoading } = useGetAllVyshhorodNewsQuery();
    useEffect(() => {
