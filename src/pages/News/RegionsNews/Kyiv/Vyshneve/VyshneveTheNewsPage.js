...
import VyshnevePostCard from '@/components/Posts/Regions/Kyiv/VyshneveNewsCard';
import RegionsPopover from '@/components/RegionPopover/RegionsPopover';
import { Paths } from '@/paths';
import { useGetAllVyshneveNewsQuery } from '@/redux/services/regionsNews/Kyiv/vyshneve';
import { Button, Input, Pagination, Spin } from 'antd';
import { useEffect, useState } from 'react';
import { useNavigate } from 'react-router-dom';
const VyshneveTheNewsPage = () => {
    ...
    const { data, isLoading } = useGetAllVyshneveNewsQuery();
    useEffect(() => {
