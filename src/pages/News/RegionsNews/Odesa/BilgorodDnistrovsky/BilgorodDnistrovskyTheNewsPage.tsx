...
const BilgorodDnistrovskyTheNewsPage: FC = () => {
  ...
  const { data, isLoading } = useGetAllBilgorodDnistrovskyNewsQuery();
  useEffect(() => {
...
export default BilgorodDnistrovskyTheNewsPage;
