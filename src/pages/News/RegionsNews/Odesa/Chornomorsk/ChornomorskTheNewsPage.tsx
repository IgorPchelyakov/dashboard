...
import ChornomorskPostCard from '@/components/Posts/Regions/Odesa/ChornomorskNewsCard';
import RegionsPopover from '@/components/RegionPopover/RegionsPopover';
import { Paths } from '@/paths';
import { useGetAllChornomorskNewsQuery } from '@/redux/services/regionsNews/Odesa/chornomorsk';
...
const ChornomorskTheNewsPage: FC = () => {
  ...
  const { data, isLoading } = useGetAllChornomorskNewsQuery();
  useEffect(() => {
...
export default ChornomorskTheNewsPage;
