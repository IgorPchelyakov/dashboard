...
import IzmailPostCard from '@/components/Posts/Regions/Odesa/IzmailNewsCard';
import RegionsPopover from '@/components/RegionPopover/RegionsPopover';
import { Paths } from '@/paths';
import { useGetAllIzmailNewsQuery } from '@/redux/services/regionsNews/Odesa/izmail';
...
const IzmailTheNewsPage: FC = () => {
  ...
  const { data, isLoading } = useGetAllIzmailNewsQuery();
  useEffect(() => {
...
export default IzmailTheNewsPage;
