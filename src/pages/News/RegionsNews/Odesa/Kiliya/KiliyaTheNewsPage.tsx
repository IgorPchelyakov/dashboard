...
import KiliyaPostCard from '@/components/Posts/Regions/Odesa/KiliyaNewsCard';
import RegionsPopover from '@/components/RegionPopover/RegionsPopover';
import { Paths } from '@/paths';
import { useGetAllKiliyaNewsQuery } from '@/redux/services/regionsNews/Odesa/kiliya';
...
const KiliyaTheNewsPage: FC = () => {
  ...
  const { data, isLoading } = useGetAllKiliyaNewsQuery();
  useEffect(() => {
...
export default KiliyaTheNewsPage;
