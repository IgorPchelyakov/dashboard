...
import OdesaPostCard from '@/components/Posts/Regions/Odesa/OdesaNewsCard';
import RegionsPopover from '@/components/RegionPopover/RegionsPopover';
import { Paths } from '@/paths';
import { useGetAllOdesaNewsQuery } from '@/redux/services/regionsNews/Odesa/odesa';
...
const OdesaTheNewsPage: FC = () => {
  ...
  const { data, isLoading } = useGetAllOdesaNewsQuery();
  useEffect(() => {
...
export default OdesaTheNewsPage;
