...
import PodilskPostCard from '@/components/Posts/Regions/Odesa/PodilskNewsCard';
import RegionsPopover from '@/components/RegionPopover/RegionsPopover';
import { Paths } from '@/paths';
import { useGetAllPodilskNewsQuery } from '@/redux/services/regionsNews/Odesa/podilsk';
...
const PodilskTheNewsPage: FC = () => {
  ...
  const { data, isLoading } = useGetAllPodilskNewsQuery();
  useEffect(() => {
...
export default PodilskTheNewsPage;
