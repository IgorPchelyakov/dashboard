...
import YouzhnePostCard from '@/components/Posts/Regions/Odesa/YouzhneNewsCard';
import RegionsPopover from '@/components/RegionPopover/RegionsPopover';
import { Paths } from '@/paths';
import { useGetAllYouzhneNewsQuery } from '@/redux/services/regionsNews/Odesa/youzhne';
...
const YouzhneTheNewsPage: FC = () => {
  ...
  const { data, isLoading } = useGetAllYouzhneNewsQuery();
  useEffect(() => {
...
export default YouzhneTheNewsPage;
